...
contract Governance is Ownable, ERC20, ERC20Wrapper, ERC20Votes {
    ...
    /**
     * @dev Steal excess tokens from `account` if it has more than 25% of the total supply. This is used to prevent an address from owning more than 25% of the voting power and avoid legal issues.
     */
